...
declare -A MOTION_FROM_START=(
  ...
  [jiujitsu/blockCrouch]="stays fully crouched in a low guard the ENTIRE time — hips down in a deep squat, forearms up at his face covering his body — and breathes with a gentle continuous sway, his shoulders and torso rising and settling a little and his weight shifting slightly. He NEVER rises up, NEVER straightens his legs, and NEVER lowers the guard. Perfectly flat uniform magenta background, no texture or speckle"
  [monk/blockCrouch]="stays fully crouched in a low horse-stance guard the ENTIRE time — hips down, thighs bent, forearms up covering his body — and breathes with a gentle continuous sway, his shoulders and torso rising and settling a little and his weight shifting slightly. He NEVER rises up, NEVER straightens his legs, and NEVER lowers the guard. Perfectly flat uniform magenta background, no texture or speckle"
)
